...
- 把基础地址填为 `https://cn.crazyrouter.com/v1`
- 把 API Key 填为 `sk-xxx`
- 第一个验证模型先用 `gpt-5.5`
...
<Tip>
如果插件让你填写的是“基础地址”，优先填 `https://cn.crazyrouter.com/v1`。只有在插件明确要求“完整聊天接口地址”时，再填 `https://cn.crazyrouter.com/v1/chat/completions`。
</Tip>
...
- [ ] 已把基础地址填写为 `https://cn.crazyrouter.com/v1` 或完整接口地址
- [ ] 已正确填写 `sk-xxx`
- [ ] 已先只配置 `gpt-5.5`
- [ ] 修改设置后已按需重启 Zotero
- [ ] 已完成单篇摘要或单篇翻译验证
...
| 404 | 基础地址或完整接口地址填错 | 基础地址改回 `https://cn.crazyrouter.com/v1`，或完整地址改回 `https://cn.crazyrouter.com/v1/chat/completions` |
...
优先填 `https://cn.crazyrouter.com/v1`。
