...
| 使用场景 | 推荐模型 | 原因 |
|----------|----------|------|
| 首轮最小验证 | `gpt-4.1-mini` | 成本更低，适合先测通链路 |
| 日常网页翻译 | `gpt-4.1-mini` | 速度和成本更平衡 |
| 更高质量翻译 | `gpt-4.1` | 适合更重质量的场景 |
...
- [ ] 首个模型已设置为 `gpt-4.1-mini` 或其他已放行模型
- [ ] 小段选中文本翻译成功
- [ ] 短网页翻译成功
...
| 成本上涨过快 | 直接整页、整站或电子书翻译 | 先用 `gpt-4.1-mini`，并控制翻译范围 |
