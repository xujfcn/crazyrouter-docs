...
| 使用场景 | 推荐模型 | 原因 |
|----------|----------|------|
| 首轮链路验证 | `gpt-4.1` | 最适合先确认 Coze 到 Crazyrouter 的调用链路 |
| 低成本试运行 | `gpt-4.1-mini` | 成本更低，适合插件与工作流调试 |
| 更强质量输出 | `claude-sonnet-4-6` | 适合更强解释和内容生成 |
...
| `model not found` | 模型名写错 | 先改回 `gpt-4.1` 重新验证 |
