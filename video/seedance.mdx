...
```bash cURL
curl -X POST https://cn.crazyrouter.com/volc/v1/contents/generations/tasks \
...
response = requests.post(
    "https://cn.crazyrouter.com/volc/v1/contents/generations/tasks",
    headers={
...
```bash cURL
curl https://cn.crazyrouter.com/volc/v1/contents/generations/tasks/cgt_task_abc123 \
  -H "Authorization: Bearer YOUR_API_KEY"
```
