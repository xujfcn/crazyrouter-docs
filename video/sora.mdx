...
```bash cURL
curl https://cn.crazyrouter.com/v1/video/generations/video_123 \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash cURL
curl "https://cn.crazyrouter.com/v1/video/query?task_id=your_task_id" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash cURL
curl -X POST https://cn.crazyrouter.com/v1/videos \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
    "model": "sora-2",
...
```bash cURL
curl https://cn.crazyrouter.com/v1/videos/sora_task_abc123 \
  -H "Authorization: Bearer YOUR_API_KEY"
```
