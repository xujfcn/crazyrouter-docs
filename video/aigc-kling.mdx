...
| `aigc-video-kling-3.1` | Kling 3.1 | 文生、图生、首尾帧、参考图 |
| `aigc-video-kling-3.1-fast` | Kling 3.1 Fast | 文生、图生、首尾帧、参考图 |
| `aigc-video-kling-3.1-lite` | Kling 3.1 Lite | 文生、图生、首尾帧、参考图 |
