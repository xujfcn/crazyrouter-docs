...
- OpenAI 兼容：`https://cn.crazyrouter.com/v1`
- Anthropic 原生：`https://crazyrouter.com`
- Gemini 原生：`https://cn.crazyrouter.com/v1beta/models/...`

## 最短迁移原则

从 OpenAI 兼容客户端迁移到 Crazyrouter，通常只需要改两项：

1. `base_url` 改成 `https://cn.crazyrouter.com/v1`
...
- 明确需要 thinking block：优先 `claude-opus-4-7`
...
| 最快接入 Gemini | OpenAI 兼容或 Gemini 原生 + `gemini-3-pro` |
| 要 reasoning 摘要 | Responses API |
| 要 Claude thinking block | `claude-opus-4-7` |
