...
| --- | --- | --- | --- | --- | --- |
| `gpt-54` | `gpt-5.5` | `$2.50` | `$0.25` | `$15.00` | 标准价适用于 `270K` 以下；超长上下文另有乘数 |
...
| 站内模型名 | 官方对应 | 官方计费方式 | 特别说明 |
| --- | --- | --- | --- |
| `gpt-54` | 站内别名，通常对应 OpenAI `gpt-5.5` | 按 `input / cached input / output` 计费 | `gpt-5.5` 的公开标准价适用于 `270K` 以下上下文；区域处理端点另有 `+10%` |
