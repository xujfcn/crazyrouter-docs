...
| `claude-opus-4-7` | Anthropic Messages | `content[].type = "thinking"` | 与 `text` block 并列返回 |
| `gemini-3-pro` | Gemini Native | `usageMetadata.thoughtsTokenCount` | 说明 thinking budget 已实际消耗 |
