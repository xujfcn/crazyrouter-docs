...
<Note>
  For more details on native Gemini image requests, see [Gemini Image Generation](/ru/chat/gemini/image-gen). If you still have older code using the Nano Banana-family Images API, migrate `nano-banana-2` to the native Gemini path documented here.
</Note>
