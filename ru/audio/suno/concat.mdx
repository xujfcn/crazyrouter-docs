...
```bash cURL
curl -X POST https://cn.crazyrouter.com/suno/submit/concat \
...
response = requests.post(
    "https://cn.crazyrouter.com/suno/submit/concat",
    headers={
...
<Note>
  After submitting a concatenation task, use the [Task Query](/ru/audio/suno/query) endpoint to get results. The concatenated song will generate a new clip ID.
</Note>
