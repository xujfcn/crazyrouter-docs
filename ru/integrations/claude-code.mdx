...
> Тестирование выполнялось на `https://api.crazyrouter.com/v1/messages` с заголовком `anthropic-version: 2023-06-01` и стандартным телом запроса Anthropic Messages.
