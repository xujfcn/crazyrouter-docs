...
Recommended order: get `gpt-5.5` working first, then add `claude-sonnet-4-6` and `gemini-3-pro`.
...
- Default to `gpt-5.5`, then switch to `claude-sonnet-4-6` for harder long-form and code tasks
