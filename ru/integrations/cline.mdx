...
- recommended default models: `claude-sonnet-4-6` or `gpt-5.5`
...
Recommended rollout: get the workflow stable on `claude-sonnet-4-6` first. If you also want an OpenAI-compatible baseline, add `gpt-5.5` second.
...
- [ ] `Base URL` is `https://cn.crazyrouter.com/v1`
...
| `404` | base URL was set to the root domain or a full endpoint path | use `https://cn.crazyrouter.com/v1` |
...
- use `claude-sonnet-4-6` or `gpt-5.5` for complex refactors
