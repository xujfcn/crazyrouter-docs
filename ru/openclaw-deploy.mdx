...
Leave the installer defaults unless you are intentionally changing provider modes: `https://cn.crazyrouter.com/v1` for the OpenAI-compatible provider, and `https://crazyrouter.com` for Claude / MiniMax native-compatible providers.
