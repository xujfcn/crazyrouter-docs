...
description: "Production-revalidated Gemini 3 Pro via /v1/chat/completions"
---
...
<Note>
  ...
  The currently preferred entry point is [Nano Banana 2](/ru/images/nano-banana-2), which now points to native Gemini `POST /v1beta/models/nano-banana-2:generateContent`.
