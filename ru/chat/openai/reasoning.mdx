...
- If you need a stable, inspectable reasoning output, prefer the Responses API and see [GPT-5 Thinking Mode](/ru/chat/responses/gpt5-thinking)
...
- [AI Thinking Fields](/ru/reference/thinking)
