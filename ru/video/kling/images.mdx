...
```bash cURL
curl -X POST https://cn.crazyrouter.com/kling/v1/images/generations \
...
response = requests.post(
    "https://cn.crazyrouter.com/kling/v1/images/generations",
    headers={
...
```bash cURL
curl https://cn.crazyrouter.com/kling/v1/images/generations/2037177945839673344 \
  -H "Authorization: Bearer YOUR_API_KEY"
```
