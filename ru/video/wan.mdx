...
For the full request and task-query schema, see [Ali Bailian Video API](/ru/video/alibailian). This page closes only the first batch of public `Wan` models, capabilities, and billing truth.
