...
<Note>
  API routes: OpenAI-compatible клиенты обычно используют `https://cn.crazyrouter.com/v1` или `https://cn.crazyrouter.com/v1`; Claude Code и Anthropic-native клиенты используют корневой домен без `/v1`. См. [API Endpoints](/ru/api-endpoint).
</Note>
