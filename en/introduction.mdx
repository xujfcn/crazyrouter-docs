...
<Note>
  API routes: OpenAI-compatible clients usually use `https://cn.crazyrouter.com/v1` or `https://cn.crazyrouter.com/v1`; Claude Code and Anthropic-native clients use the root domain without `/v1`. See [API Endpoints](/en/api-endpoint).
</Note>
