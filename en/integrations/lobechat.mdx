...
| Higher-quality writing / code help | `claude-opus-4-8` | Strong long-form writing and reasoning |
| Gemini fallback path | `gemini-3.1-pro` | Useful as a second vendor-compatible validation path |

Recommended order: get `gpt-5.5` working first, then expand to `claude-opus-4-8` and `gemini-3.1-pro`.
