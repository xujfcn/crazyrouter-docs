...
- recommended first validation model: `gpt-4.1-mini`
...
|----------|-------------------|-----|
| first-pass minimal validation | `gpt-4.1-mini` | lower cost and ideal for proving the route works |
| everyday webpage translation | `gpt-4.1-mini` | better speed and cost balance |
| higher-quality translation | `gpt-4.1` | better for more quality-sensitive content |
...
- [ ] the first model is `gpt-4.1-mini` or another allowed model
...
| cost rises too fast | you started with full-page or full-document translation immediately | begin with `gpt-4.1-mini` and translate smaller scope first |
