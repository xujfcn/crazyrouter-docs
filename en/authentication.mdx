...
<Note>
For OpenAI-compatible access, use `https://cn.crazyrouter.com/v1` by default. If you are configuring Claude Code, Hermes, OpenClaw, or another client, check [API Endpoints](https://docs.crazyrouter.com/en/api-endpoint) first.
</Note>
