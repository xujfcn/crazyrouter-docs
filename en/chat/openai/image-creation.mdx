...
- If you need stable, machine-readable image output, the current recommended path is [`/v1/images/generations`](/images/gpt-image) with `gpt-image-1`
...
<Note>
  If you are only testing manually, the `gpt-4o-image` chat path is still useful for observation. If you need backend automation, storage, or post-processing, use the [`GPT Image docs`](/images/gpt-image) directly.
</Note>
