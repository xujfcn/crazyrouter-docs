...
- If you need stable, machine-readable image output, the current recommended path is [`/v1/images/generations`](/en/images/gpt-image) with `gpt-image-1`; for Grok image models, see [`Grok Image Models`](/en/images/grok)
