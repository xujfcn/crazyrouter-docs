...
- If you need stable, machine-readable image output, the current recommended path is [`/v1/images/generations`](/en/images/gpt-image) with `gpt-image-1`
- If you need reference-image editing or multi-image input, use the Nano Banana family Images API pages: [`Nano Banana`](/en/images/nano-banana), [`Nano Banana Pro`](/en/images/nano-banana-pro), and [`Nano Banana 2`](/en/images/nano-banana-2)
...
<Note>
  If you are only testing manually, the `gpt-4o-image` chat path is still useful for observation. If you need backend automation, storage, or post-processing, use the [`GPT Image docs`](/en/images/gpt-image) directly. If your workload depends on reference-image editing or multi-image input, use [`Nano Banana`](/en/images/nano-banana), [`Nano Banana Pro`](/en/images/nano-banana-pro), or [`Nano Banana 2`](/en/images/nano-banana-2) instead.
</Note>
