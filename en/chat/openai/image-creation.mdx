...
`gpt-image-2` accepts `response_format="url"` and `response_format="b64_json"` as legacy compatibility fields, but new integrations should use `output_format="png"`, `"jpeg"`, or `"webp"` to choose the image file format.
