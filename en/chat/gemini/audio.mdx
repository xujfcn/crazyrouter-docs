...
<Note>
  This page only covers the short-audio understanding path that was actually rechecked successfully. For longer STT workflows or TTS, see the existing [STT](/en/audio/stt) and [TTS](/en/audio/tts) pages; Realtime is not currently shown as a public recommended example.
</Note>
