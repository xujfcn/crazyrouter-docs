...
<Note>
  This page still only covers the `/v1/chat/completions` compatibility layer and does not fold Gemini-backed image behavior into it. If you need Crazyrouter's current public image contract, use the Nano Banana family pages for `POST /v1/images/generations`:
