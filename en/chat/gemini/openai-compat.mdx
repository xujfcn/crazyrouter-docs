...
<Note>
  ...
  The currently preferred entry point is [Nano Banana 2](/en/images/nano-banana-2), which now points to native Gemini `POST /v1beta/models/gemini-3.1-flash-image-preview:generateContent`.
