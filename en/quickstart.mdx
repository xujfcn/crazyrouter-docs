...
<Note>
Use `https://cn.crazyrouter.com/v1` as the default access address. If you are unsure whether a tool should use the root domain or `/v1`, check [API Endpoints](https://docs.crazyrouter.com/en/api-endpoint) first.
</Note>
