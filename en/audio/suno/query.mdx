...
```bash cURL
curl https://cn.crazyrouter.com/suno/fetch/suno_task_abc123 \
...
response = requests.get(
    "https://cn.crazyrouter.com/suno/fetch/suno_task_abc123",
...
```bash cURL
curl -X POST https://cn.crazyrouter.com/suno/fetch \
