...
response = requests.post(
    "https://cn.crazyrouter.com/v1/videos",
    headers={
...
```bash cURL
curl https://cn.crazyrouter.com/v1/videos/video_abc123 \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash cURL
curl -o output.mp4 https://cn.crazyrouter.com/v1/videos/video_abc123/content \
  -H "Authorization: Bearer YOUR_API_KEY"
```
