...
| `aigc-video-kling-3.1` | Kling 3.1 | text-to-video, image-to-video, first-last frames, references |
| `aigc-video-kling-3.1-fast` | Kling 3.1 Fast | text-to-video, image-to-video, first-last frames, references |
| `aigc-video-kling-3.1-lite` | Kling 3.1 Lite | text-to-video, image-to-video, first-last frames, references |
