...
<Note>
Prefer `https://cn.crazyrouter.com/v1` by default. If you are unsure whether a client should use the root domain or `/v1`, check [API Endpoints](https://docs.crazyrouter.com/en/api-endpoint) first.
</Note>
