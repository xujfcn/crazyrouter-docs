...
```bash cURL
curl -X POST https://cn.crazyrouter.com/fal-ai/nano-banana \
...
response = requests.post(
    "https://cn.crazyrouter.com/fal-ai/nano-banana",
    headers={
...
```bash cURL
curl -X POST https://cn.crazyrouter.com/fal-ai/nano-banana/edit \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
