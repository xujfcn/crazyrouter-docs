...
```bash cURL
curl -X POST https://cn.crazyrouter.com/ideogram/v1/ideogram-v3/generate \
...
response = requests.post(
    "https://cn.crazyrouter.com/ideogram/v1/ideogram-v3/generate",
    headers={
...
```bash cURL
curl -X POST https://cn.crazyrouter.com/ideogram/v1/ideogram-v3/edit \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
...
```bash cURL
curl -X POST https://cn.crazyrouter.com/ideogram/v1/ideogram-v3/remix \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
...
```bash cURL
curl -X POST https://cn.crazyrouter.com/ideogram/v1/ideogram-v3/replace-background \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
