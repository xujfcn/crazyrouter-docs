...
Model names, prices, billing modes, and endpoint support must align with https://crazyrouter.com/pricing and https://api.crazyrouter.com/api/pricing?lang=en.
...
- Model names, prices, billing modes, and endpoint types come from the [Pricing page](https://crazyrouter.com/pricing) and `GET https://api.crazyrouter.com/api/pricing?lang=en`.
