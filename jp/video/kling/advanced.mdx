...
```bash cURL
curl -X POST https://cn.crazyrouter.com/kling/v1/images/kolors-virtual-try-on \
...
```bash cURL
curl https://cn.crazyrouter.com/kling/v1/images/kolors-virtual-try-on/866361099762425934 \
  -H "Authorization: Bearer YOUR_API_KEY"
```
