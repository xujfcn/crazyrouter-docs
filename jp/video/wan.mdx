...
For Ali-shaped workflows, see the full request and task-query schema in [Ali Bailian Video API](/jp/video/alibailian). This page closes the first batch of public `Wan` models, capabilities, billing truth, and recommended protocol.
