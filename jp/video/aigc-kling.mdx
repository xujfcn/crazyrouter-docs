...
| `aigc-video-kling-3.1` | Kling 3.1 | テキストから動画、画像から動画、始終フレーム、参照画像 |
| `aigc-video-kling-3.1-fast` | Kling 3.1 Fast | テキストから動画、画像から動画、始終フレーム、参照画像 |
| `aigc-video-kling-3.1-lite` | Kling 3.1 Lite | テキストから動画、画像から動画、始終フレーム、参照画像 |
