...
```bash cURL
curl -X POST https://cn.crazyrouter.com/mj/submit/imagine \
...
response = requests.post(
    "https://cn.crazyrouter.com/mj/submit/imagine",
    headers={
...
<Note>
  After successful submission, a task ID is returned. Use the [Query Task Status](/jp/images/midjourney/query) endpoint to get the generation result.
</Note>
