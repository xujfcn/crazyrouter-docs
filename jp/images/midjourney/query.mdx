...
```bash cURL
curl https://cn.crazyrouter.com/mj/task/task_1234567890/fetch \
...
response = requests.get(
    "https://cn.crazyrouter.com/mj/task/task_1234567890/fetch",
...
```bash cURL
curl -X POST https://cn.crazyrouter.com/mj/task/list-by-condition \
