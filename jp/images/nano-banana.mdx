...
1. If you need a usable image-generation or image-editing route right now, start with [Nano Banana 2](/jp/images/nano-banana-2)
...
```bash
curl "https://cn.crazyrouter.com/v1beta/models/nano-banana:generateContent?key=YOUR_API_KEY" \
...
<Note>
  If you need the currently healthier Gemini image path on Crazyrouter, see [Gemini Image Generation](/jp/chat/gemini/image-gen). If you need the more usable Nano Banana-family route right now, start with [Nano Banana 2](/jp/images/nano-banana-2).
</Note>
