---
title: "Grok 画像モデル"
description: "grok-4-image と grok-4-image で画像を生成し、対応パラメータと違いを確認する"
---
> 更新日: 2026-06-06
...
| Model | 説明 | 推奨 |
|-------|------|------|
| `grok-4-image` | xAI 公式の画像モデル名。公式価格 `$0.02 / image` で課金 | 新規連携に推奨 |
...
|-----------|------|----------|------|
| `model` | string | Yes | `grok-4-image` を指定 |
