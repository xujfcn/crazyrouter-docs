...
```bash
curl https://cn.crazyrouter.com/v1/messages \
  -H "Content-Type: application/json" \
...
- [OpenAI Reasoning](/jp/chat/openai/reasoning)
- [GPT-5 Thinking](/jp/chat/responses/gpt5-thinking)
- [Thinking Fields](/jp/reference/thinking)
- [Claude Native Messages](/jp/chat/anthropic/messages)
- [Gemini Native API](/jp/chat/gemini/native)
