---
title: 'Python Vision'
description: 'Python image recognition with gpt-5.5 and Claude'
---
> 更新日: 2026-06-06
...
<Note>
  Vision input with `gpt-5.5` and `claude-sonnet-4-6` was verified in Crazyrouter production on March 23, 2026. Image size should not exceed 20MB; base64 encoding adds approximately 33% to the payload size, so URL method is recommended for larger files.
</Note>
