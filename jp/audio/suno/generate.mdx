...
```bash cURL
curl -X POST https://cn.crazyrouter.com/suno/submit/music \
...
response = requests.post(
    "https://cn.crazyrouter.com/suno/submit/music",
    headers={
...
<Note>
  Each submission generates 2 song variants. After submission, use the [Task Query](/jp/audio/suno/query) endpoint to get results.
</Note>
