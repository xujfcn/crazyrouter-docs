...
<Note>
  After submitting a concatenation task, use the [Task Query](/jp/audio/suno/query) endpoint to get results. The concatenated song will generate a new clip ID.
</Note>
