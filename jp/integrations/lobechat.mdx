...
|---------|--------------|-----|
| settings cannot be saved or validation fails | wrong API key or wrong proxy URL | recheck the `sk-...` value and `https://api.crazyrouter.com/v1` |
...
| 404 | proxy URL was entered as the root domain or a full endpoint path | change it to `https://api.crazyrouter.com/v1` |
