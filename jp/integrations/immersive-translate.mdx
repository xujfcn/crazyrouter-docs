...
- service type: `OpenAI`
- API key: your `sk-...`
- custom API URL: `https://cn.crazyrouter.com/v1/chat/completions`
...
- [ ] `Custom API URL` is `https://cn.crazyrouter.com/v1/chat/completions`
...
|---------|--------------|-----|
| `404` | the API URL is missing `/chat/completions`, or only the root domain was entered | switch to the full `https://cn.crazyrouter.com/v1/chat/completions` URL |
...
Use the full path: `https://cn.crazyrouter.com/v1/chat/completions`.
