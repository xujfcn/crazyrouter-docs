...
- If you need strict JSON instead of JSON-looking text, combine this route with [Structured Outputs](/jp/features/structured-outputs)

<Note>
  This page only covers the short-audio understanding path that was actually rechecked successfully. For longer STT workflows, realtime audio, or TTS, see the existing [STT](/jp/audio/stt), [Realtime](/jp/audio/realtime), and [TTS](/jp/audio/tts) pages.
</Note>
