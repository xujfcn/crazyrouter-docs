...
<Note>
  ...
  The currently preferred entry point is [Nano Banana 2](/jp/images/nano-banana-2), which now points to native Gemini `POST /v1beta/models/nano-banana-2:generateContent`.
