...
- for Gemini-specific capabilities such as structured outputs, Google Search, and thinking, you should still prefer [Gemini Native Format](/jp/chat/gemini/native)
...
- If you need Gemini-native structured outputs, Google Search, thinking, or native metadata, use [Gemini Native Format](/jp/chat/gemini/native)
...
<Note>
  ...
  The currently preferred entry point is [Nano Banana 2](/jp/images/nano-banana-2), which now points to native Gemini `POST /v1beta/models/gemini-3.1-flash-image-preview:generateContent`.
  [Nano Banana](/jp/images/nano-banana) remains controlled-testing only.
</Note>
