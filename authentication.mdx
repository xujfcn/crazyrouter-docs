...
<Note>
OpenAI 兼容接入默认使用 `https://cn.crazyrouter.com/v1`。如果你要给 Claude Code、Hermes、OpenClaw 或其他工具配置地址，先参考 [API Endpoint 说明](https://docs.crazyrouter.com/en/api-endpoint)。
</Note>
