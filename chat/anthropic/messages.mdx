---
title: "Claude 原生格式"
description: "基于生产环境复核，使用 Anthropic Messages API 调用 Claude"
---
> 更新日期：2026-06-06
...
基础版 `claude-opus-4-6` 本轮没有拿到同等明确的 thinking block，因此这里优先写 thinking 能力。
...
- 明确需要 thinking block：优先用 `claude-opus-4-7`
